...
export const FAQ_ITEMS: { q: string; a: string }[] = [
  ...
  { q: "How much is delivery?", a: "Below ₦50,000, delivery costs ₦2,500 within Lagos, ₦4,000 to Abuja/Ogun/Oyo, and ₦4,500 to other states. Interstate delivery (outside Lagos) is free from ₦50,000. Lagos delivery is free from ₦150,000. Free-delivery eligibility is based on your product subtotal before discounts." },
  { q: "What payment methods do you accept?", a: "At checkout, choose instant payment on WhatsApp to request account details with your order and product links, or choose website bank transfer to see our account number and exact total. After transferring, report payment on your order page. We confirm payment only after checking the actual bank account." },
  { q: "How long is my order reserved?", a: "Your order is reserved for six hours while awaiting payment. For either payment option, transfer within six hours and use the payment-report button on your order page after sending money. Unpaid orders without a report become eligible for automatic cancellation after six hours (the cancellation job may run later). A reported payment keeps your order reserved for manual bank verification until our team confirms it or resolves the order with you. Reporting is not confirmation of payment. Never transfer to a cancelled order; contact us if you already paid and need help." },
...
export const SHIPPING_SECTIONS: InfoSection[] = [
  ...
  { title: "Delivery fees", body: ["Lagos: ₦2,500 · Abuja, Ogun & Oyo: ₦4,000 · Other states: ₦4,500 (fees apply below the applicable free-delivery threshold).", "Interstate delivery to every state outside Lagos is FREE on product subtotals of ₦50,000 or more. Delivery within Lagos is FREE from ₦150,000. Eligibility uses the product subtotal before coupon discounts."] },
...
export const TERMS_SECTIONS: InfoSection[] = [
  ...
  { title: "Orders & payment", body: ["Choose WhatsApp instant payment or website bank transfer at checkout. Placing an order reserves stock for six hours while payment is pending. For either option, pay within six hours and report the transfer using the button on your order page. We verify money received in our actual bank account before marking the order paid and beginning fulfilment. An unpaid order with no report becomes eligible for automatic cancellation and stock release after six hours; GitHub scheduled checks can run late. A reported transfer remains pending and reserved until our team verifies it or contacts you to resolve the order, including manual cancellation if necessary. Reporting payment is not proof of receipt. Do not pay a cancelled order; contact us promptly if you already transferred money and need help." ] },
  ...
  { title: "Delivery & risk", body: ["Delivery timelines are estimates. Interstate delivery is free from a ₦50,000 product subtotal; Lagos delivery is free from ₦150,000, before discounts. Risk in the goods passes to you on delivery to the address provided."] },
